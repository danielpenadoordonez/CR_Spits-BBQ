...
router.get("/:id", auth.grantRole(["Administrador", "Mesero", "Cliente"]), pedidoController.getPedidoById);
...
router.put("/updateState/:id", auth.grantRole(["Administrador", "Mesero", "Cliente"]), pedidoController.updatePedido);
